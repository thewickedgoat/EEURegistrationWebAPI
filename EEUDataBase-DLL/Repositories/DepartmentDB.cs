...
{
    class DepartmentDB : IDataBase<Department, int>
    {
        private IContext context;

        public DepartmentDB(IContext context)
        {
        ...
        public List<Department> ReadAll()
        {
            using (var dbContext = GetContext())
            {
                ...
                foreach (var department in departments)
                {
                    ...
                    {
                        List<Absence> absences = dbContext.Employees.Include("Absences").FirstOrDefault(x => x.Id == employee.Id).Absences;
                        if (absences != null)
                        {
                        ...
                        {
                            employee.Absences = new List<Absence>();
                        }
                    }
                }
                return departments;
